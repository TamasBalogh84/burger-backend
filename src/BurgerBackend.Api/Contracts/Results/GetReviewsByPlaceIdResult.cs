...
public class GetReviewsByPlaceIdResult : ResultBase
{
    ...
    public static GetReviewsByPlaceIdResult BadRequest(string? message = null) => new (ResultFactory.CreateContentResultWithValidationProblemDetails(HttpStatusCode.BadRequest, message));
